              ...
              >
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="bg-[#00ff00] text-black font-bold hover:bg-[#00cc00] px-6 py-2 rounded text-xl transition-all hover:drop-shadow-[0_0_10px_#00ff00] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  <button
                    ...
                    disabled={respondingTo === invitation.id}
                    className="bg-[#ff0000] text-white font-bold hover:bg-[#cc0000] px-6 py-2 rounded text-xl transition-all hover:drop-shadow-[0_0_10px_#ff0000] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
