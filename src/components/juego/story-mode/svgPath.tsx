...
import type { LevelMapProps } from "../../../types/mode/story-mode/level";
        ...
        <div className="relative z-10 flex-1 overflow-y-auto overflow-x-hidden px-4 pt-12 text-white">
            <div className="relative mx-auto" style={{ height: "2000px" }}>
                ...
                {levels.map((level, index) => {
                    ...
                    const unlocked = level.numero <= ultimoNivelCompletado + 1; // el siguiente al último completado también está desbloqueado
                    const isCyan = level.numero % 2 === 1; // alterna colores entre niveles
