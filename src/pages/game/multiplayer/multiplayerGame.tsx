...
export const Menu = () => {
  const botonVolver = " text-black text-xl  py-2 px-4 rounded-[6px] hover:bg-red-700 transition duration-300 mx-auto block mt-10 hover:drop-shadow-[0_0_10px_#00ffff]";
  return (

    <div
      className="h-screen w-screen multijugadorContenedor fondo-multijugador"    >
      <h1 className=" titulo text-pink-400 text-5xl  flex justify-center tracking-wide  mb-8 drop-shadow-[0_0_10px_#00ffff]">Multijugador</h1>
      <div className="contenedorMenu bg-white/10 rounded-lg p-8 flex flex-col items-center">


        <Link to="/crear" className="botonGral hover:drop-shadow-[0_0_10px_#00ffff]" style={{gridArea:"crear"}}>Crear Partida</Link>
