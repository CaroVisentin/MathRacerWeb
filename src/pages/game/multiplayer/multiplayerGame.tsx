...
export const Menu = () => {
  ...
  return (
    <div className="h-screen w-screen multijugadorContenedor fondo-multijugador">
      ...
      <div className="contenedorMenu bg-white/10 rounded-lg p-8 flex flex-col items-center">
        ...
        <Link to="/crear"
          className="botonGral uppercase tracking-wider transition-all duration-300 ease-out hover:drop-shadow-[0_0_10px_#00ffff]"
          style={{ gridArea: "crear" }}
        >
          Crear Partida
        </Link>
        ...
        <Link to="/partida-rapida" className="botonGral uppercase hover:drop-shadow-[0_0_10px_#00ffff]" style={{ gridArea: "competitiva", width: "50%", justifySelf: "center", }}>Partida Competitiva</Link>
      </div>
