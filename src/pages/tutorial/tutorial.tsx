...
//  const handleCloseTutorialChest = async () => {
  ...
  return (
    <>
      ...
      {mostrarCofre ? (
        <RewardScreen
          isChestOpen={isCofreOpen}
          setIsChestOpen={setIsCofreOpen}
          rewards={recompensas}
          setRewards={setRecompensas}
          obtainedChest={chest}
          setShowChest={setMostrarCofre}
          setObtainedChest={setChest}
          cofre={cofre}
        ...
        <div className="juego w-full h-full bg-black text-white relative">
          ...
          {/* HEADER */}
          <div
            className={`flex justify-between items-center bg-black px-4 py-3 z-10 ${mostrarVidas ? "z-60" : ""}`}
          >
              ...
              <div className="relative">
                ...
                <div className="bg-[#0F7079] border-4 border-white px-10 py-8 text-center shadow-lg pointer-events-auto">
                  ...
                  <p className="text-lg mb-5 text-white leading-snug">
                    Verás la ecuación a resolver y debajo la condición que debes
                    cumplir
                  </p>
                </div>
              </div>
          ...
          {/* Ruta */}
          <div
            className={`mt-20 flex flex-col gap-3 justify-end ${mostrarCarrera ? "z-60" : ""}`}
          >
            <div
          ...
          <div className="flex flex-col justify-center items-center h-full gap-5 !mb-10 mt-4 bg-black ">
            <div className="flex justify-center mb-6">
              <div
                className={`inline-block border-2 border-white rounded-lg text-5xl px-6 py-3 ${mostrarObjetivo ? "z-60" : ""}`}
              >
            ...
            {/* Opciones */}
            <div
              className={`flex justify-center items-center mt-3 gap-6 opciones ${mostrarOpciones ? "z-60" : ""}`}
            >
                ...
                <button
                  ...
                  onClick={() => {
                    if (opcion === 6) {
                      ...
                      setOpcionesIncorrectas(
                        opciones.map((_, idx) => idx === i)
                      );
                      setMostrarJuguemos(false);
                      setMostrarOpcionIncorrecta(true);
