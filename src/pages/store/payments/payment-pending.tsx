...
export default function PaymentPending() {
  return (
    <div className="min-h-screen w-screen bg-[#050308] flex items-center justify-center relative overflow-hidden px-4 py-12">
      <div className="relative max-w-4xl w-full border border-white/20 p-8 md:p-12 drop-shadow-[0_0_35px_rgba(0,240,255,0.45)]">
        <div className="absolute -inset-1 blur-2xl opacity-25" />
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="flex-1 text-center md:text-left space-y-6">
            ...
            <p className="text-gray-200 text-lg md:text-3xl">
              Mercado Pago está validando tu pago. En unos instantes verás las monedas acreditadas.
            </p>
