            ...
            <div className="relative flex flex-col items-center text-center text-white px-6 py-10 space-y-10">
                ...
                <div className="space-y-8 max-w-4xl">
                    {step === 1 && (
                        <>
                            <p className="text-3xl leading-relaxed">
                                Math Racer es un juego de carreras donde para avanzar en la pista deberás resolver ecuaciones correctamente.
                                Cada respuesta acertada hace que tu auto avance y te acerque a la meta.<br />
                            ...
                            <ul className="list-disc list-inside text-3xl space-y-4">
                                <li> Encuentra el valor de <span className="text-[#00F4FF]">x</span> para que <span className="text-[#00F4FF]">y</span> sea el número mayor posible </li>
                                <li> Encuentra el valor de <span className="text-[#00F4FF]">x</span> para que <span className="text-[#00F4FF]">y</span> sea el número menor posible </li>
                            </ul>
                        </>
                    )}
                    ...
                    {step === 2 && (
                        <>
                            <ul className="list-disc list-inside text-3xl space-y-4">
                                <li> <span className="text-[#00F4FF]">MULTIJUGADOR: </span>Compite contra otros jugadores en carreras rápidas. Gana el que llegue primero a la meta. Cada victoria te da puntos para subir en el ranking</li>
                                <li> <span className="text-[#00F4FF]">HISTORIA: </span>Juega solo contra la máquina, avanza por niveles y mundos con dificultad creciente. Al superar niveles recibes monedas o premios sorpresa.</li>
                            </ul>

                            <div className="!mt-12 space-y-4">
                                <h2 className="text-4xl">VIDAS</h2>
                                <p className="text-2xl">
                                    El modo HISTORIA cuenta con 3 vidas, al perder un nivel perderá <span className="text-[#00F4FF]">una vida</span>. Las mismas se recargarán con tiempo o canjeandolas por monedas.
                                </p>
                            </div>
                        </>
                    )}
